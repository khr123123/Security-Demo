package org.khr.securitydemo.manager;
...
public class CounterManager {
    ...
    public long incrAndGetCounter(String key, int timeInterval, TimeUnit timeUnit, long expirationTimeInSeconds) {
        ...
        Object countObj = script.eval(
                ...
                luaScript,  //Lua 脚本 字符串
                RScript.ReturnType.INTEGER,  //脚本返回的是计数（数字）
                Collections.singletonList(redisKey), //这里传 1 个 redis key，Lua 脚本中用 KEYS[1] 获取
                expirationTimeInSeconds  //脚本中的 ARGV[1] 用作过期时间（单位：秒）
        );
